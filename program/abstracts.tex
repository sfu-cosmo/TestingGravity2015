...
An extreme mass ratio inspiral (EMRI) system is a binary black hole system where the black holes have highly disparate masses (M$_1$/M$_2$ from 1000:1 to $10^6$:1).  Gravitational-wave observations of such a system can be used for highly precise tests of strong-field general relativity.  In this talk and the accompanying poster, I'll briefly introduce EMRI phenomenology, and outline some of the methods used to theoretically model EMRI orbital dynamics and the resulting gravitational waves.
