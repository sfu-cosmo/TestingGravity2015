...
\usepackage[pdfauthor={Testing Gravity 2015},pdftitle={Contributed Talk Abstracts},colorlinks,urlcolor={RegentGrey}]{hyperref}
...
\rhead{\fontspec{Lato Light Italic}\Large Contributed Talk Abstracts, page~\thepage}
\lfoot{}\cfoot{}\rfoot{}
...
\item \talk{Jannis R. Bielefeld (Dartmouth)}{The mechanics of aether (3 min)}
...
\item \talk{Javier Fernando Chagoya (U. Guanajuato)}{Galileons in strong gravity (poster)}
...
\item \talk{Chryssomalis Chryssomalakos (UNAM)}{Operational geometry with extended probes (3 min)}
...
\item \talk{Walter Del Pozzo (Birmingham U.)}{Testing general relativity with gravitational waves observations (3 min)}
...
\item \talk{Jason Dossett (Brera)}{Current constraints on testing general relativity with the latest cosmological datasets (7 min)}
...
\item \talk{Robert Ferdman (McGill)}{Using pulsars in a galactic-scale gravitational-wave detector (10 min)}
...
\item \talk{Orest Hrycyna (NCNR, Poland)}{Dynamics and observational constraints on Brans-Dicke cosmological model (3 min + poster)}
...
\item \talk{Jeffrey Hyde (Arizona State U.)}{Gravitational waves from preheating of a Higgs-like scalar (3 min)}
...
\item \talk{Hideo Iguchi (CST, Nihon U.)}{Black hole thermodynamics based on non-extensive thermodynamic functions (poster)}
...
\item \talk{Mustapha Ishak-Boushaki (UT Dallas)}{Recent results and tensions on modified growth parameter constraints (7 min)}
...
\item \talk{Alejo Stark (U. Michigan)}{A novel test of gravity in galaxy cluster scales (3 min + poster)}
...
\item \talk{Fumika Suzuki (UBC)}{Environmental gravitational decoherence in the weak coupling regime (poster)}
...
\item \talk{Alexandra Terrana (York U./Perimeter)}{Tensor modes in bigravity, primordial to present (3 min)}
...
\item \talk{William Terrano (U. Wash)}{Looking for torsion in general relativity, or the role of spin in gravity (3 min + poster)}
...
\item \talk{Jonathan Thornburg (Indiana U.)}{Highly precise tests of strong-field GR (3 min + poster)}
...
\item \talk{David W. Tian (Memorial U. Newfoundland)}{Thermodynamics-gravity correspondence of the universe in general relativity and modified gravity (3 min)}

We have develop a unified and compact formulation in which the Friedmann equations can be derived from nonequilibrium thermodynamics of the FRW Universe, with applications to the minimally coupled f(R), generalized Brans-Dicke, scalar-tensor-chameleon, quadratic, f(R,G) generalized Gauss-Bonnet, and dynamical Chern-Simons gravity.

\item \talk{Amol Upadhye (U. Wisconsin-Madison)}{Large-scale structure as a test of dark energy and modified gravity (3 min)}
...
\item \talk{Kei Yamada (Hirosaki U.)}{Relativistic Sagnac effects by Chern-Simons gravity (3 min + poster)}
