...
\centerline{\fontsize{32pt}{64pt}\fontspec{Lato Hairline}If you have institutional access,}

\medskip
\centerline{\fontsize{32pt}{64pt}\fontspec{Lato Hairline}connect to {\fontspec{Lato Light Italic}eduroam}. Otherwise, }

\bigskip
\centerline{\fontsize{32pt}{64pt}\fontspec{Lato Hairline} connect to {\fontspec{Lato Light Italic}SFUNET}, and}

\medskip
\centerline{\fontsize{32pt}{64pt}\fontspec{Lato Hairline} use login credentials below:}
